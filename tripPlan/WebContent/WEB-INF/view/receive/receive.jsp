		...
		<table class="table">
			<thead>
				<tr height="30">
					...
					<td align="center" style="position: absolute; left:395;">보낸이</td>
					<td align="center" style="position: absolute; right:130;">날짜</td>
					<td align="center" style="float:right;">수신확인</td>
				</tr>
			</thead>
					...
					<table style="width:100%; font-size:13px;">
						<c:forEach var="receive" items="${receiveList}">
							<tr height="30">
								...
								<td align="center" style="position: absolute; left: 15%;"><a href="content.do?rm_id=${receive.rm_id}&pageNum=${currentPage}">
								${receive.rm_title}</a></td>
								<td align="center" style="text-align:center; position: absolute; right:260;">${receive.rm_sender}</td>
								<td align="center" style="text-align:center; position: absolute; right:90;">${receive.rm_date}</td>
