...
<body>
	...
	<div class="container">
		<form action="receivedelete.do" method="post">
			<div class="btn-group">
				<a href="sendwrite.do" class="btn btn-info" role="button">쪽지 쓰기</a>
				<a href="receive.do" class="btn btn-info receive" role="button">받은 쪽지 &nbsp;&nbsp;${count} </a> <a
					href="send.do" class="btn btn-info" role="button">보낸 쪽지&nbsp;&nbsp;${s_count}</a>
			</div>
							...
							<c:forEach var="receive" items="${receiveList}">
								<tr height="30">
									<td align="center" style="position: absolute; left: 18;"><input
										type="checkbox" id="chk" name="chk" value="${receive.rm_id}" /></td>
