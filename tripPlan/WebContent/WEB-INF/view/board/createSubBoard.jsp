...
<div id="body">
<div id="map"></div>
<button class="btn btn-primary add_root_btn"><i class="fa fa-plus">경로생성</i></button>
		...
		<article class="page">
	     	 ...
	     	 <table border="1" width="400" height="400">
				<tr height="50">
					...
					<td width="150" colspan="2"><input id="originInput" class="controls" required="required" type="text" name="sb_lat" placeholder="출발지를 입력해 주세요.">
					<br/>
					...
					<td colspan="1" width="50"><input id="calculate-route" type="button" value="길찾기!"><input id="routeClear" type="button" value="초기화"></td>
				</tr>  
				<tr height="250">
