$(document).ready(function() {
    ...
    $('#sgsg').click(function() {
    	var lon = ["37.5665350", "36.6424340", "35.1795540"];
    	var lat = ["126.9779690", "127.4890320", "129.0756420"];
    ...
    $(document).on('click',".add_root_btn", function() {
         ...
         if (x < max_fields){ //max input box allowed
             ...
             html = html + '<li class="timeline-milestone is-completed timeline-start">';
             		...
             		html = html + '<table border="1" width="400" height="400">';
             			html = html + '<tr height="50">';
             				...
             				html = html + '<td width="150" colspan="2">';
             					html = html + '<input id="originInput" class="controls" required="required" type="text" name="sb_lat" placeholder="출발지를 입력해 주세요."><br/>';
             	...
             	html = html + '</div>';
             html = html + '</li>';				
             //$(wrapper).append('<li class="timeline-milestone is-completed timeline-start"><div class="timeline-action"><table border="1" width="400" height="400"><tr height="50"><td width="50" colspan="1">여행지</td><td width="150" colspan="2"><input id="originInput" class="controls" required="required" type="text" name="sb_lat" placeholder="출발지를 입력해 주세요."><br/><a id="originInput-link" href="#">Get my position</a></td><td width="150" colspan="2"><input id="destinationInput" class="controls" type="text" name="sb_lon" placeholder="도착지를 입력해 주세요."><br/><a id="destinationInput-link" href="#">Get my position</a></td><td colspan="1" width="50"><input id="calculate-route" type="button" value="길찾기!"><input id="routeClear" type="button" value="초기화"></td></tr> <tr height="250"><td width="50"colspan="1">내용</td><td width="250" colspan="5"><textarea rows="10" cols="100" name="sb_subcontent"></textarea></td></tr><tr height="50"><td width="50" colspan="1">교통비</td><td width="50" colspan="1"><input type="text" name="sb_tcharge"></td><td width="50" colspan="1">식비</td><td width="50" colspan="1"><input type="text" name="sb_fcharge"></td><td width="50" colspan="1">숙박비</td><td width="50" colspan="1"><input type="text" name="sb_rcharge"></td></tr><tr height="50" ><td colspan="6" width="400"><button class="btn btn-danger remove-btn">경로 삭제</button></td></tr></table></div></li>'); //add input box
         }
