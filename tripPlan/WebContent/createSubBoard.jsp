	...
	<body>
		<div id="body">
			...
			<form id="calculate-route" name="calculate-route" action="#" method="get"style="margin-left:650px; margin-top:-480px">
								...
								<table border="1" width="600" height="400">
									<tr height="50">
										...
										<td width="200" colspan="2">
											<input id="originInput" class="controls" required="required" type="text" name="sb_lat" placeholder="출발지를 입력해 주세요."><br/>
				...
				<input type="button" class="btn btn-success controls" style="margin:auto;"value="생성" onclick="createSubBoard.do"/>
