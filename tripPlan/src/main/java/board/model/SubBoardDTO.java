...
public class SubBoardDTO {
	...
	private Timestamp sb_spendtime;
	...
	public SubBoardDTO(){}
	public SubBoardDTO(int sb_id, String sb_subcontent, int sb_price, Timestamp sb_spendtime, String sb_photo1,
			String sb_photo2, String sb_photo3, String sb_photo4, String sb_photo5, String sb_lat, String sb_lon,
			int sb_procedure, int b_id) {
		super();
		this.sb_id = sb_id;
	...
	public Timestamp getSb_spendtime() {
		return sb_spendtime;
	}
	public void setSb_spendtime(Timestamp sb_spendtime) {
		this.sb_spendtime = sb_spendtime;
	}
