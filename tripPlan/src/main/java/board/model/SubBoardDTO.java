...
public class SubBoardDTO {
	...
	public SubBoardDTO(String sb_subcontent, int sb_tcharge, int sb_fcharge, int sb_rcharge, String sb_spendtime,
			String sb_photo1, String sb_photo2, String sb_photo3, String sb_photo4, String sb_photo5, String sb_lat,
			String sb_lon, int sb_procedure, int b_id) {
		this.sb_subcontent = sb_subcontent;
		this.sb_tcharge = sb_tcharge;
		this.sb_fcharge = sb_fcharge;
		this.sb_rcharge = sb_rcharge;
		this.sb_spendtime = sb_spendtime;
	...
	public SubBoardDTO(int sb_id, String sb_subcontent, int sb_tcharge, int sb_fcharge, int sb_rcharge,
			String sb_spendtime, String sb_photo1, String sb_photo2, String sb_photo3, String sb_photo4,
	...
	public String getSb_spendtime() {
		return sb_spendtime;
	}

	public void setSb_spendtime(String sb_spendtime) {
		this.sb_spendtime = sb_spendtime;
	}
	...
	public String toString() {
		return "sb_subcontent :: "+sb_subcontent+" sb_tcharge :: "+sb_tcharge+" sb_fcharge :: "+sb_fcharge+" sb_rcharge :: "+sb_rcharge+"sb_lat :: "+sb_lat+" sb_lon"+sb_lon;
	}
}
